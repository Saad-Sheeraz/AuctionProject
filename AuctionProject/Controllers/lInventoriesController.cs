...
namespace AuctionProject.Controllers
{
    ...
    [ApiController]
    public class lInventoriesController : ControllerBase
    {
        private readonly AuctionProjectDBContext _context;

        public lInventoriesController(AuctionProjectDBContext context)
        {
            _context = context;
        }

        // GET: api/lInventories
        [HttpGet]
